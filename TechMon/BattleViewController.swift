...
class BattleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //プレイヤーと敵のステータスを設定
        player = Player(name: "勇者", imageName: "yusya.png", attackPoint: 20, fireAttackPoint: 50, maxHP: 100, maxTP: 40)
        enemy = Enemy(name: "ドラゴン", imageName: "monster.png", attackPoint: 10, maxHP: 300)

        //プレイヤーのステータスを反映
        playerNameLabel.text = player.name
        playerImageView.image = player.image
        playerTPLabel.text = String(player.currentTP) + "/ 40"
